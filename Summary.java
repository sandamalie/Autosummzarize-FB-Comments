...
import facebook4j.FacebookException;// used to integrate with facebook profile(we have to import facebook4j.jar file to connect java and facebook developer portal or access the contents)
import javax.swing.*;
...
public class summary extends JFrame implements ActionListener {
    ...
    public JPanel addToolbar() {
        ...
        JButton jb4 = new JButton("Upload Comments");//To uplaod the postcommentsPreprocessed  textfile
        ...
        JButton jb5 = new JButton("Stemming");//to keep the root wrds and remove all relevant words form the selected sentences
